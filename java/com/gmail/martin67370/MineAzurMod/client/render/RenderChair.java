...
public class RenderChair implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		renderer.setRenderBounds(0.2F, 0.0F, 0.2F, 0.3F, 0.4F, 0.3F);
		renderer.renderStandardBlock(block, x, y, z);
		renderer.setRenderBounds(0.8F, 0.0F, 0.2F, 0.9F, 0.4F, 0.3F);
		renderer.renderStandardBlock(block, x, y, z);
		renderer.setRenderBounds(0.2F, 0.0F, 0.8F, 0.3F, 0.4F, 0.9F);
		renderer.renderStandardBlock(block, x, y, z);
		renderer.setRenderBounds(0.8F, 0.0F, 0.8F, 0.9F, 0.4F, 0.9F);
		renderer.renderStandardBlock(block, x, y, z);
		renderer.setRenderBounds(0.1F, 0.4F, 0.1F, 0.9F, 0.55F, 0.9F);
		renderer.renderStandardBlock(block, x, y, z);
